...
// Для прототипа это нормально — access-токены живут всего 15 минут и сами
// перестанут быть валидными. Персистентность (Redis, БД) и общий чёрный
// список между несколькими экземплярами сервера — задачи боевой версии.
