...
// decodedView — то, что decode печатает на stdout. Сам байтовый блок подписи
// показывать смысла нет — для глаз это случайный шум; но размер полезен,
// чтобы быстро понять, какой алгоритм использовался (ECDSA P-256 даёт
// около 70 байт, ML-DSA-65 — 3309 байт, гибрид — ещё больше; см.
// docs/bench_crypto.md).
