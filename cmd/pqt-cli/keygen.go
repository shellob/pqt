...
func runKeygen(args []string) error {
	...
	// 0o700: в директории лежат приватные ключи, пускать туда других
	// пользователей системы по умолчанию не надо.
...
// generatePrivateKey генерирует свежий приватный ключ нужного алгоритма.
// Для гибридных алгоритмов классическая часть (ECDSA P-256) фиксирована,
// варьируется только уровень ML-DSA.
